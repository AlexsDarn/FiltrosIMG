...
def ecualizacion_hyperbolica(): 
    ...
    newim.save(ruta_base + 'ecualizacionHyperbolica.gif') 
    imagen_l = PhotoImage(file = ruta_base + 'ecualizacionHyperbolica.gif')
    global ecualizacionHyperbolica    
    ecualizacionHyperbolica = canvas.create_image(600, 160, anchor=NW, image=imagen_l)
    ventana.mainloop()